...
function playTrailer(trailerUrl) {
  ...
  // Set title
  modalTitle.textContent = "Fifty Shades of Grey";

  // Hide the 'Trailer Not Found' message
  document.querySelector(".movieNotFound").classList.add("d-none");

  // Show iframe in case it was hidden
  iframe.classList.remove("d-none");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (logoutBtn) {
    logoutBtn.addEventListener('click', function () {
      ...
      window.location.href = 'netflix.html'; // Redirect to login page
    });
  }
});
